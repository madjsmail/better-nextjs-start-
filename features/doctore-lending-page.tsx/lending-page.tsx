...
const NavLink: React.FC<NavLinkProps> = ({ href = "#", children, hasDropdown = false, className = "", onClick }) => (
    ...
    >
        ...
        {!hasDropdown && (
            <motion.div
                className="absolute bottom-[-2px] left-0 right-0 h-[1px] bg-paypal-light-blue"
...
const InteractiveHero: React.FC = () => {
        ...
        for (let i = 0; i < cols; i++) {
            for (let j = 0; j < rows; j++) {
                ...
                newDots.push({
                    x,
                    y,
                    baseColor: `rgba(135, 220, 255, ${BASE_OPACITY_MAX})`,
    ...
    const animateDots = useCallback(() => {
        ...
        dots.forEach((dot, index) => {
            ...
            const r = colorMatch ? colorMatch[1] : '135';
        ...
        <div className="pt-[100px] relative bg-[#111111] text-gray-300 min-h-screen flex flex-col overflow-x-hidden">
            ...
            >
                <nav className="flex justify-between items-center max-w-screen-xl mx-auto h-[70px]">
                    ...
                    <div className="flex items-center flex-shrink-0 space-x-4 lg:space-x-6">
                        ...
                        <motion.a
                            href="#"
                            className="bg-paypal-light-blue text-[#111111] px-4 py-[6px] rounded-md text-sm font-semibold hover:bg-opacity-90 transition-colors duration-200 whitespace-nowrap shadow-sm hover:shadow-md"
            ...
            <main className="flex-grow flex flex-col items-center justify-center text-center px-4 pt-8 pb-16 relative z-10">
                ...
                <motion.div
                    ...
                    className="mb-6"
                >
                    <ShinyText text="Announcing our $15M Series A" className="bg-[#1a1a1a] border border-gray-700 text-paypal-light-blue px-4 py-1 rounded-full text-xs sm:text-sm font-medium cursor-pointer hover:border-ptext-paypal-light-blue/50 transition-colors" />
                </motion.div>
                ...
                >
                    ...
                    <span className="inline-block h-[1.2em] sm:h-[1.2em] lg:h-[1.2em] overflow-hidden align-bottom">
                        <RotatingText
                            ...
                            mainClassName="text-paypal-light-blue mx-1"
                            staggerFrom={"last"}
                            initial={{ y: "-100%", opacity: 0 }}
                            animate={{ y: 0, opacity: 1 }}
                ...
                >
                    <input
                        ...
                        className="flex-grow w-full sm:w-auto px-4 py-2 rounded-md bg-[#2a2a2a] border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-ptext-paypal-light-blue focus:border-transparent transition-all"
                    />
                    <motion.button
                        type="submit"
                        className="w-full sm:w-auto bg-paypal-light-blue text-[#111111] px-5 py-2 rounded-md text-sm font-semibold hover:bg-opacity-90 transition-colors duration-200 whitespace-nowrap shadow-sm hover:shadow-md flex-shrink-0"
                        whileHover={{ scale: 1.03, y: -1 }}
                        whileTap={{ scale: 0.97 }}
                        transition={{ type: "spring", stiffness: 400, damping: 15 }}
                    >
